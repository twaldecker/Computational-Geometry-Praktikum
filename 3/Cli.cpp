...
void Cli::help() {
  cout << "linesweep - a program to calculate intersections of lines." << endl
      << " Usage:" << endl << "  linesweep [-h] filename" << endl
      << "  -h displays this help message" << endl << endl << " File layout:"
      << endl << "  1.100 1.50001 1.3 1.5" << endl
      << "  which are the values of x and y of the startpoint and of the endpoint."
      << endl << "  Lines are separated by a newline." << endl << endl
      << " Output:" << endl
